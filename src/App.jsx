    ...
    >
      ...
      <div className="flex flex-col w-full gap-2 justify-between">
        ...
        <div className="studentSection flex flex-col gap-2">
          <div className="allStudents rounded-md border border-gray-400 p-2">
          ...
          <div className="presentStudents rounded-md border border-gray-400 p-2">
          ...
          <div className="absentStudents rounded-md border border-gray-400 p-2">
